...
## クリーンアーキテクチャの各層の概要
![clean_architecture](/image/architecture/clean_architecture_handson/klean_architecture.jpg)
...
### 双方向でのモデルの変換
![双方向でのモデルの変換](/image/architecture/clean_architecture_handson/change_each_other.jpg)
...
### 徹底的なモデルの変換
![徹底的なモデルの変換](/image/architecture/clean_architecture_handson/change_in_depth.jpg)
- 各層ごとにモデルを変換する
- メリット
...
### 一方向でのモデルの変換
![一方向でのモデルの変換](/image/architecture/clean_architecture_handson/change_one_direction.jpg)
